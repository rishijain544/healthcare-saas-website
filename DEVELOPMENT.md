...
```bash
git remote add encore encore://healthcare-saas-website-z872
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/healthcare-saas-website-z872/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/healthcare-saas-website-z872/settings/integrations/github)
